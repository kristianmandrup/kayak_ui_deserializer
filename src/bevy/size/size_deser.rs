...
pub fn deserialize_size(size: SSize) -> Result<Size, &'static str>  {
    SizeDeser::new(size).deserialize()
}

pub struct SizeDeser {
    node: SSize,
}
impl SizeDeser {
    ...
    pub fn deserialize(&self) -> Result<Size, &'static str> {        
